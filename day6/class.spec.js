...
// })
(0, test_1.test)("TC_002 Auto Waits", function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        var cardToSelect, buttonToClick, hiddenButton;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, page.goto("https://leafground.com/waits.xhtml")];
                case 1:
                    _b.sent();
                    cardToSelect = page.locator(".card").filter({ hasText: "Wait for Visibility" });
                    buttonToClick = cardToSelect.getByRole("button").filter({ hasText: "Click" });
                    buttonToClick.click();
                    hiddenButton = cardToSelect.getByRole("button").filter({ hasText: "I am here" });
                    return [4 /*yield*/, (0, test_1.expect)(hiddenButton).toBeVisible({ timeout: 15000 })];
                case 2:
                    _b.sent();
